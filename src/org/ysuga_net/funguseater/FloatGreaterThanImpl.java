...
// -*- Java -*-
/*!
 * @file  FloatGreaterThanImpl.java
 * @brief Component goes to Deactivated if data is greater than x
 * @date  $Date: 2010/02/19 13:39:30 $
 *
 * $Id: FloatGreaterThanImpl.java,v 1.1 2010/02/19 13:39:30 ysuga Exp $
 */
...
/*!
 * @class FloatGreaterThanImpl
 * @brief Component goes to Deactivated if data is greater than x
 *
 */
public class FloatGreaterThanImpl extends DataFlowComponentBase {

  /*!
   * @brief constructor
   * @param manager Maneger Object
   */
	public FloatGreaterThanImpl(Manager manager) {  
        super(manager);
    ...
    protected ReturnCode_t onInitialize() {
        bindParameter("threshold", m_threshold, "1.0f");
        m_threshold.value = 1.0f;
...
//
     ...
     */
    protected FloatHolder m_threshold = new FloatHolder();
	// </rtc-template>
