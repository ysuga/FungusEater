...
import org.ysuga_net.funguseater.controller.FungusEater;
import org.ysuga_net.funguseater.simulator.VehicleSim;



public class Loader implements ModuleInitProc {
	public void myModuleInit(Manager mgr) {
	      Properties prop1 = new Properties(FungusEater.component_conf);
	      mgr.registerFactory(prop1, new FungusEater(), new FungusEater());

	      // Create a component
	      RTObject_impl comp1 = mgr.createComponent("FungusEater");
	      if( comp1==null ) {
	      ...
	      Properties prop2 = new Properties(FloatGreaterThan.component_conf);
	      mgr.registerFactory(prop2, new FloatGreaterThan(), new FloatGreaterThan());

	      // Create a component
	      RTObject_impl comp2 = mgr.createComponent("FloatGreaterThan");
	      if( comp2==null ) {
	    	  System.err.println("Component create failed.");
	    	  System.exit(0);
	      }
	      ...
	      Properties prop3 = new Properties(FloatLessThan.component_conf);
	      mgr.registerFactory(prop3, new FloatLessThan(), new FloatLessThan());

	      // Create a component
	      RTObject_impl comp3 = mgr.createComponent("FloatLessThan");
	      if( comp3==null ) {
	    	  System.err.println("Component create failed.");
	    	  System.exit(0);
	      }
	      ...
	      Properties prop4 = new Properties(VehicleSim.component_conf);
	      mgr.registerFactory(prop4, new VehicleSim(), new VehicleSim());

	      // Create a component
	      RTObject_impl comp4 = mgr.createComponent("VehicleSim");
	      if( comp4==null ) {
	    	  System.err.println("Component create failed.");
	    	  System.exit(0);
	      }
